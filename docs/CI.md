...
The deploy SP needs **Contributor** on the resource group and **Storage Blob Data Contributor** on the storage account (`scripts/bootstrap-tfstate.sh` grants the latter).
